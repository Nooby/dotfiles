return { -- Fuzzy Finder (files, lsp, etc)
  ...
  config = function()
    ...
    vim.keymap.set('n', '<leader>n', builtin.find_files, { desc = '[S]earch [F]iles' })
    vim.keymap.set('n', '<leader>gc', builtin.git_commits, { desc = '[S]earch [C]ommits' })
    ...
    vim.keymap.set('n', '<leader>cs', builtin.lsp_dynamic_workspace_symbols, { desc = '[C]ode [S]ymbols (LSP Dynamic)' })
