...
require('lazy').setup({
  ...
  -- require 'nooby.autocomplete', -- Autocomplete config (nvim-cmp, luasnip, copilot)
  -- require 'nooby.lsp', -- Language Server Protocol (LSP) config (mason, lspconfig, neodev)
  -- require 'nooby.remap', -- Remap keys (keymaps, which-key)
  --
